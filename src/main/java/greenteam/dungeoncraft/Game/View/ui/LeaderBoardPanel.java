...
public class LeaderBoardPanel extends GameObjectUI {

    private GameObjectText playerTextLine;
    private List<String> lines;

    /* Constructor */
    public LeaderBoardPanel(Texture tex, float xPosInScreenSpace, float yPosInScreenSpace, int zIndex, float width,
